...
COMMON_OPTION3 = 
COMMON_OPTION4 = -fdefault-real-8 -fdefault-double-8  -I ${NETCDF_INCLUDE_DIR}
WARNING_FLAGS = -Wall -Wuninitialized -Wline-truncation  -Wcharacter-truncation  -Wsurprising  -Waliasing  -Wimplicit-interface  -Wno-unused-parameter  -fwhole-file  -fcheck=all  -fbacktrace -Wno-implicit-interface -Wno-conversion -fallow-argument-mismatch -fno-align-commons -fno-automatic -fdefault-real-8 -fdefault-double-8 -Wno-unused -Wno-unused-dummy-argument
