...
WARNING_FLAGS = -Wall -Wuninitialized -Wline-truncation  -Wcharacter-truncation  -Wsurprising  -Waliasing  -Wimplicit-interface  -Wno-unused-parameter  -fwhole-file  -fcheck=all  -fbacktrace -Wno-implicit-interface -Wno-conversion -fno-align-commons -fno-automatic -Wno-unused -Wno-unused-dummy-argument $(C13_ARGS) -ffpe-trap=zero
