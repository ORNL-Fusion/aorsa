...
!     --------------------------------------------------------
      ...
      integer :: nnode_local = 0        !-----nnode_local = number of local Fourier modes used to calculate local Wdot !not used
      ...
      integer :: nboundary = 1          !-----nboundary: if(nboundary .eq. 1)flux surface boundary (default) but sq boundary still sets how domain
