     ...
     .   vpara_mks, vperp_cgs, uperp_1kev, duperp, dz, dx
      ...
      integer pgopen, pgbeg, ier, nmid, mmid, it
     ...
     .     fmids(nxmx), fmidt(nxmx), fmid6(nxmx) 
      ...
      real mod_Ealpha(nxmx, nymx), mod_Ebeta(nxmx, nymx)            
...
c     .        ezk(nkdim1 : nkdim2, mkdim1 : mkdim2) 
     ...
     .   ximey_dx, ximez_dx, spx, spy, spz, reomg1a, reomg2a, reomg3a,          
     .   capr_bpol, pressi, redotj1, redotj2, redotj3,
     ...
     .   redotj4, redotj5, redotj6, divq, capd, capd_plot, xkb, xkb_plot
...
c
     ...
     .   capr, rmin_zoom, rmax_zoom, xnmin, xnmax)     
      ...
      call ezzoom1(title, titll, titlr, titlb, capr, xnmid,
     .    fmid1, fmid2, fmid3, fmid4, fmid5,
     .    nnodex, nxmx, xnmin, xnmax, rmin_zoom, rmax_zoom)
...
c      close (61)
	 ...
	 deallocate (Wpar2_cql)
      ...
      deallocate (xkperp_cold, acold, xkperp_cold2,
     ...
     .     eykmod, ezkmod, exklog, eyklog, ezklog )
      ...
      deallocate (xn, xkti, xkte, rho, theta,
     .   psi, xjy, bmod, xjx, xiota, qsafety, ipsi, btau, bzeta,
     .   freal, fimag, fmod, mod_Eplus, mod_Eminus, mod_Eb,
     .   dldb_tot12, reex_dx, reey_dx, reez_dx, ximex_dx,
     .   ximey_dx, ximez_dx, spx, spy, spz, reomg1a, reomg2a, reomg3a,          
