...
c***************************************************************************
c
      subroutine wdot_new_z_maxwellian_i(z2_electron, 
...
!           ----------------------------------
	    ...
	    if (ndist .eq. 0)
     .          call QLSUM_MAXWELLIAN_z2_ion(i,j, ni, b_sum, c_sum, 
     .               e_sum, f_sum,
...
!     -------------------
 ...
 1311 format(1p9e12.4)
  ...
  102 format (4i6, 1p8e12.4)
      ...
      end subroutine wdot_new_z_maxwellian_i
