...
!     --------------------------------------------------------
      ...
      logical :: use_fourier_z2 = .false. !-----if (use_fourier_z2 .eq. .true.)  Fourier expansion along field line for electrons with l = 0 
                                          !-----if (use_fourier_z2 .eq. .false.) NO Fourier expansion along field for electrons with l = 0  (default)					  				   					  
