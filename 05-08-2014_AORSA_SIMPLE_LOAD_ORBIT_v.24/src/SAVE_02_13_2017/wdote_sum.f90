...
!
    ...
    subroutine QLSUM_MAXWELLIAN_z2_electron(ip, jp, k_uper, b_sum, c_sum,  & 
       & e_sum, f_sum, &
...
!    end if
  ...
  end subroutine QLSUM_MAXWELLIAN_z2_electron
