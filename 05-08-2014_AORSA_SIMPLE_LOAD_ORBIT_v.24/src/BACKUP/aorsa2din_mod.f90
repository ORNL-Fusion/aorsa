...
!     --------------------------------------------------------
      ...
      integer :: version_number = 22      !-----version_number: version of AORSA         
      ...
      logical :: use_new_z2 = .false.     !-----if (use_new_z2 .eq. .true.)  use the toroidally broadened Z2 for electrons with l = 0 
                                          !-----if (use_new_z2 .eq. .false.) use the original Z2 function consistent with nzfun (default)
					  
      logical :: use_fourier_z2 = .true.  !-----if (use_fourier_z2 .eq. .true.)  Fourier expansion along field line for electrons with l = 0 (default)
                                          !-----if (use_fourier_z2 .eq. .false.) NO Fourier expansion along field for electrons with l = 0 
					  
      logical :: revised_secular = .true.  !-----if (revised_secular .eq. .true.)  Revised secular term is used in the phase (default)
                                           !-----if (revised_secular .eq. .false.) Original secular term is used in the phase 					  					  				   					  					  					  					   
      ...
      integer :: nmodeslb = 64            !-----nmodeslb =number of modes used along the field line
      integer :: lbmaxq = 1               !-----lbmaxq = lbmax / (2 pi R) in the Fourier expansion along the field line
      ...
      namelist/aorsa2din/nmodesx, nmodesy, nmodeslb, lbmaxq, nwdot, lmax, ibessel, &
     ...
     &    xkx_ono, xky_ono, curved_ant, yplot, use_new_Z2, use_fourier_Z2, &
     &    revised_secular
